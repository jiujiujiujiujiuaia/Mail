...
<div class="header" id="home">
    <div class="container">
        <ul>
            <li> <a href="#" data-toggle="modal" data-target="#myModal"><i class="fa fa-unlock-alt" aria-hidden="true"></i>欢迎${customer.c_name} </a></li>
            <li> <a href="../logout.html/" ><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Logout </a></li>

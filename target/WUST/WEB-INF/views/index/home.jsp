...
<%@ page import="edu.princeton.cs.algs4.StdOut" %>
...
<div class="header" id="home">
    <div class="container">
        <ul>
            ...
            <li><i class="fa fa-phone" aria-hidden="true"></i>Accout</li>
    ...
    <div class="container">
        ...
        <div class="top_nav_right">
            <div class="wthreecartaits wthreecartaits2 cart cart box_1">
                <form action="/Index/Home" method="post" class="last">
                    <input type="hidden" name="display" value="1">
                    <input type="hidden" id="uid" value="${customer.c_id}">
                    <button class="w3view-cart" onclick="islogin()" type="submit" name="submit" value=""><i class="fa fa-cart-arrow-down" aria-hidden="true"></i></button>
                </form>
                            ...
                            <div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out button2">
                                <form action="#" method="post">
                                    <fieldset>
                                        ...
                                        <a href ="http://localhost:8081/Goods/detail?idd=<%=id%>"><input type="text" name="submit" value="add to cart" class="button" /></a>
                                    </fieldset>
                                </form>
                            </div>
